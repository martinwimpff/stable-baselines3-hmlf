...
class PDQN(OffPolicyAlgorithm):
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        self.logger.record("train/loss_q", np.mean(loss_q))
        self.logger.record("train/loss_parameter", np.mean(loss_parameter))
    ...
    def _update_learning_rate(self, optimizer_q: th.optim.Optimizer, optimizer_parameter: th.optim.Optimizer) -> None:
        ...
        self.logger.record("train/learning_rate_q", self.lr_schedule_q(self._current_progress_remaining))
        self.logger.record("train/learning_rate_parameter", self.lr_schedule_parameter(self._current_progress_remaining))
